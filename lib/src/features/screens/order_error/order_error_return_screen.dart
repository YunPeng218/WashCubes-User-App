...
import 'package:device_run_test/src/features/screens/order_error/order_error_status_widget.dart';
import 'package:device_run_test/src/features/screens/order_error/order_error_collection_widget.dart';
...
class OrderErrorStatusScreen extends StatefulWidget {
  final Order order;
  const OrderErrorStatusScreen({super.key, required this.order});

  @override
  State<OrderErrorStatusScreen> createState() => OrderErrorStatusState();
}

class OrderErrorStatusState extends State<OrderErrorStatusScreen> {
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              children: [
                OrderErrorStatusWidget(
                  order: widget.order,
                ),
                const Divider(),
                OrderErrorDetailWidget(
                  order: widget.order,
                  lockerSite: lockerSite,
